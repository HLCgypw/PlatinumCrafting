...
public class MSoundEvents {
    public static final DeferredRegister<SoundEvent> SOUND = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, PlatinumCore.MOD_ID);
    //声音注册
    ...
    public static RegistryObject<SoundEvent> regSoundEvent(String name){
        return SOUND.register(name,()-> new SoundEvent(new ResourceLocation(PlatinumCore.MOD_ID,name)));
    }

...
public class MWorldEvents {
    ...
    public static void biomeLoadingEvent(final BiomeLoadingEvent event){
        MOreGeneration.generateOre(event);
        MStructureGeneration.GenerateStructures(event);
    }
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(MStructures.SB1.get(),
                    DimensionStructuresSettings.field_236191_b_.get(MStructures.SB1.get()));

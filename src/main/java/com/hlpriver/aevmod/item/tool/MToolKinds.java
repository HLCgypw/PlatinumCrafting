...
public class MToolKinds {
    ...
    //铂金工具
    //斧头
    public static final RegistryObject<ToolItem> PLATINUM_AXE = ITEMS.register("platinum_axe",
            ()-> new AxeItem(MItemTier.PLATINUM,8.0F,-3.6F,new Item.Properties().group(MItemGroup.PLATINUM_TAB_ONE)));
    //镐子
    public static final RegistryObject<ToolItem> PLATINUM_PICKAXE = ITEMS.register("platinum_pickaxe",
            ()-> new PickaxeItem(MItemTier.PLATINUM,4,-2.6F,new Item.Properties().group(MItemGroup.PLATINUM_TAB_ONE)));
    //锄头
    public static final RegistryObject<ToolItem> PLATINUM_HOE = ITEMS.register("platinum_hoe",
            ()-> new HoeItem(MItemTier.PLATINUM,2,-0.5F,new Item.Properties().group(MItemGroup.PLATINUM_TAB_ONE)));
    //铲锹
    public static final RegistryObject<ToolItem> PLATINUM_SHOVEL = ITEMS.register("platinum_shovel",
